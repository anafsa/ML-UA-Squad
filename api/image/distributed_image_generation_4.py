...
prompt_text = f"{reduced_story_prompts[current_prompt_index]} using a cartoonished style"

previous_prompt = ""
if current_prompt_index > 0:
    previous_prompt = reduced_story_prompts[current_prompt_index-1]
    prompt_text = prompt_text + f". Generate an image using a cartoonished style depticing the {init_prompts[current_prompt_index]} incorporating elements from the image generated using this prompt: {previous_prompt}."
